    ...
    return (
        <section className="bg-[#f4f4f4] py-16 px-6 md:px-12">
            ...
            <div className="max-w-6xl mx-auto text-center">
                <h2 className="text-4xl font-extrabold text-[#1d3c6a] mb-4">Get in Touch</h2>
            ...
            <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-xl hover:shadow-2xl transition-shadow duration-300">
                <form onSubmit={handleSubmit} className="space-y-8">
                    <div>
                        <label className="block text-[#1d3c6a] text-lg font-semibold mb-2">Your Name</label>
                        <input
                            type="text"
                            name="name"
                            value={formData.name}
                    ...
                    <div>
                        <label className="block text-[#1d3c6a] text-lg font-semibold mb-2">Your Email</label>
                        <input
                            type="email"
                            name="email"
                    ...
                    <div>
                        <label className="block text-[#1d3c6a] text-lg font-semibold mb-2">Message</label>
                        <textarea
                            name="message"
            ...
            <div className="max-w-6xl mx-auto mt-16 text-center">
                <h3 className="text-2xl font-extrabold text-[#1d3c6a] mb-">Our Contact Information</h3>
                <p className="text-lg text-[#333333] mb-6">We’d Love to Hear From You</p>

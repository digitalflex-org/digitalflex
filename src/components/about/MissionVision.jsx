        ...
        <section className="bg-white py-20 px-6 md:px-12">
            ...
            >
                <div className="max-w-7xl mx-auto text-center">
                    <h2 className="text-4xl font-bold text-[#333333] mb-4">Our Mission, Vision & Values</h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 text-left">
                        ...
                        <div className="bg-gray-50 p-6 rounded-xl shadow-sm hover:shadow-md transition">
                            <h3 className="text-2xl font-semibold text-[#333333] mb-3">Our Mission</h3>
                        ...
                        {/* Vision */}
                        <div className="bg-gray-50 p-6 rounded-xl shadow-sm hover:shadow-md transition">
                            <h3 className="text-2xl font-semibold text-[#333333] mb-3">Our Vision</h3>
                            <p className="text-gray-600">
